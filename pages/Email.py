...
class Email:
    # Открываем сайт 1secmail.com, делаем запрос на создание виртуального email для регистрации на https://b2c.passport.rt.ru/.
    ...
    def get_reg_code(self, login: str, domain: str, ids: str) -> json:
        # Получаем письмо с кодом регистрации от Ростелекома 
